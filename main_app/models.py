...
class Calls(models.Model):
    car_id = models.ForeignKey(Cars, on_delete=models.PROTECT, verbose_name='id кареты')
    client_id = models.ForeignKey(Clients, on_delete=models.PROTECT, verbose_name='id клиента', related_name = 'client_ids')
...
#@receiver(pre_save, sender=Calls)
#def update_accepted_date(sender, instance, **kwargs):
#    if instance.is_accepted and not instance.accepted_date:
